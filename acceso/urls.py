...
urlpatterns = [
    ...
    path(
        ...
        views.panel_producto_crear,
        name="panel_producto_crear",
    ),
    path(
        "panel/productos/<int:pk>/editar/",
        views.panel_producto_editar,
        name="panel_producto_editar",
    ),
    path(
        "panel/productos/<int:pk>/eliminar/",
        views.panel_producto_eliminar,
        name="panel_producto_eliminar",
    ),
    path("panel/pedidos/", views.panel_pedidos, name="panel_pedidos"),
    path(
        "panel/pedidos/<int:pk>/",
        views.panel_pedido_detalle,
        name="panel_pedido_detalle",
    ),
    path("panel/clientes/", views.panel_clientes, name="panel_clientes"),
    path(
        "panel/clientes/importar/",
        views.panel_clientes_importar,
        name="panel_clientes_importar",
    ),
    path("panel/empleados/", views.panel_empleados, name="panel_empleados"),
    path(
        "panel/empleados/nuevo/",
        views.panel_empleado_crear,
        name="panel_empleado_crear",
    ),
    path(
        "panel/empleados/<int:pk>/editar/",
        views.panel_empleado_editar,
        name="panel_empleado_editar",
    ),
    path(
        "panel/empleados/<int:pk>/eliminar/",
        views.panel_empleado_eliminar,
        name="panel_empleado_eliminar",
    ),
    path("panel/categorias/", views.panel_categorias, name="panel_categorias"),
    path(
        "panel/categorias/nueva/",
        views.panel_categoria_crear,
        name="panel_categoria_crear",
    ),
    path(
        "panel/categorias/<int:pk>/editar/",
        views.panel_categoria_editar,
        name="panel_categoria_editar",
    ),
    path(
        "panel/categorias/<int:pk>/eliminar/",
        views.panel_categoria_eliminar,
    ...
    path(
        "panel/sedes/<int:pk>/editar/",
        views.panel_sede_editar,
        name="panel_sede_editar",
    ),
    path(
        "panel/sedes/<int:pk>/eliminar/",
        views.panel_sede_eliminar,
        name="panel_sede_eliminar",
    ),
    path("panel/compras/", views.panel_compras, name="panel_compras"),
    path(
        "panel/productos/importar/",
        views.panel_productos_importar,
        name="panel_productos_importar",
    ),
    path(
        "panel/productos/plantilla/",
    ...
    path(
        "panel/ventas/<int:pk>/",
        views.panel_venta_detalle,
        name="panel_venta_detalle",
    ),
    path(
    ...
    path(
        ...
        views.reporte_empleados_pdf,
        name="reporte_empleados_pdf",
    ),
    path(
        "panel/reportes/productos/pdf/",
        views.reporte_productos_pdf,
        name="reporte_productos_pdf",
    ),
    path(
        "panel/reportes/pedidos/pdf/",
        views.reporte_pedidos_pdf,
        name="reporte_pedidos_pdf",
    ),
    # ── Panel Empleado ──
    path("empleado/login/", views.login_empleado, name="login_empleado"),
    path("empleado/panel/", views.panel_empleado, name="panel_empleado"),
    path(
        "empleado/productos/nuevo/",
        views.empleado_producto_crear,
        name="empleado_producto_crear",
    ),
    path(
        "empleado/productos/<int:pk>/editar/",
        views.empleado_producto_editar,
        name="empleado_producto_editar",
    ),
    path(
        "empleado/productos/<int:pk>/eliminar/",
        views.empleado_producto_eliminar,
        name="empleado_producto_eliminar",
    ),
    path(
        "empleado/agregar-producto/",
        views.agregar_producto_empleado,
        name="agregar_producto_empleado",
    ),
    path("empleado/pedidos/", views.empleado_pedidos, name="empleado_pedidos"),
    path(
        "empleado/pedidos/<int:pk>/",
        views.empleado_pedido_detalle,
        name="empleado_pedido_detalle",
    ),
    path(
        "empleado/categorias/",
        views.empleado_categorias,
        name="empleado_categorias",
    ),
    path(
        "empleado/categorias/nueva/",
        views.empleado_categoria_crear,
        name="empleado_categoria_crear",
    ),
    path(
        "empleado/categorias/<int:pk>/editar/",
        views.empleado_categoria_editar,
        name="empleado_categoria_editar",
    ),
    path(
        "empleado/categorias/<int:pk>/eliminar/",
        views.empleado_categoria_eliminar,
        name="empleado_categoria_eliminar",
    ),
    ...
    path(
        "panel/reportes/categorias/pdf/",
        views.reporte_categorias_pdf,
        name="reporte_categorias_pdf",
    ),
    path(
        "panel/reportes/clientes/pdf/",
        views.reporte_clientes_pdf,
        name="reporte_clientes_pdf",
    ),
    path(
        "panel/reportes/sedes/pdf/",
        views.reporte_sedes_pdf,
        name="reporte_sedes_pdf",
    ),
    # ── Perfil ──
